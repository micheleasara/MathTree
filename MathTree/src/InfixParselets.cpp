...
std::unique_ptr<Expression> AdditionParselet::parse(Parser& parser,
...
std::unique_ptr<Expression> SubtractionParselet::parse(Parser& parser,
                                                       std::unique_ptr<Expression> left,
                                                       Token const& token) {
  auto right = parser.parse(priority());
...
std::unique_ptr<Expression> MultiplicationParselet::parse(Parser& parser,
                                                          std::unique_ptr<Expression> left,
                                                          Token const& token) {
  auto right = parser.parse(priority());
...
std::unique_ptr<Expression> DivisionParselet::parse(Parser& parser,
                                                    std::unique_ptr<Expression> left,
                                                    Token const& token) {
  auto right = parser.parse(priority());
...
std::unique_ptr<Expression> ExponentiationParselet::parse(Parser& parser,
                                                          std::unique_ptr<Expression> left,
                                                          Token const& token) {
